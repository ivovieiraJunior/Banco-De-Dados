...
CREATE TABLE `fornecimento` (
  `Fcod` int(11) NOT NULL,
  `Pcod` int(11) DEFAULT NULL,
  `PRcod` int(11) DEFAULT NULL,
  PRIMARY KEY (`Fcod`),
  KEY `FornPeca` (`Pcod`),
  KEY `FornProje` (`PRcod`),
  CONSTRAINT `FornPeca` FOREIGN KEY (`Pcod`) REFERENCES `peca` (`Pcod`) ON UPDATE CASCADE,
  CONSTRAINT `FornProje` FOREIGN KEY (`PRcod`) REFERENCES `projeto` (`PRcod`) ON UPDATE CASCADE
...
-- Dump completed on 2019-03-13 13:51:21
